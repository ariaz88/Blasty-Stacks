...
//    [Tooltip("How many stages this level actually has (kept in sync with Home).")]
//    [Min(1)] public int stagesPerLevel = 20;

//    [Tooltip("1-based index of the stage you want to mark as completed.")]
//    [Min(1)] public int stageIndex_1Based = 1;

//    [Header("Outcome")]
//    public StarAward award = StarAward.Clear_1Star;

//    [Tooltip("If assigned, Home UI will refresh after Apply.")]
//    public Object homeManager; // keep as Object to avoid hard compile dependency on type name

//    public enum StarAward
//    {
//        Clear_1Star = 1,   // hp > 0 and < 50%
//        HP50Plus_2Star = 2,// hp >= 50% and < 100%
//        HP100_3Star = 3    // hp == 100%
//    }

//    /// <summary>
//    /// Applies the selected award to the selected (level, stage) via SaveSystem.
//    /// </summary>
//    /// 

//    private void Start()
//    {
//        //SaveSystem.ResetAll();   // deletes the "GAME_SAVE_V1" key and clears cache
...
//        if (!Application.isPlaying)
//        {
//            Debug.LogWarning("[DebugStageManager] Enter Play Mode to apply debug results.");
//            return;
//        }
//#endif
//        // Clamp and ensure level
//        int stageIndex0 = Mathf.Clamp(stageIndex_1Based - 1, 0, Mathf.Max(0, stagesPerLevel - 1));

//        // Ensure the level exists with the intended stage count
//        SaveSystem.EnsureLevel(levelId, stagesPerLevel);

//        // Map award → hpPercent thresholds your SaveSystem already uses:
//        // >=100 → 3★, >=50 → 2★, >0 → 1★
//        float hpPercent = award switch
//        {
//            StarAward.HP100_3Star => 100f,
//            StarAward.HP50Plus_2Star => 50f,
//            _ => 1f,   // any positive but <50 for 1★
//        };

//        SaveSystem.RecordStageResult(levelId, stageIndex0, hpPercent);

//        // Try to refresh Home UI if provided
//        TryRefreshHomeUI();

//        Debug.Log($"[DebugStageManager] Applied {award} to Level {levelId}, Stage {stageIndex_1Based} (hp={hpPercent}%).");
//    }
...
//        // We don't hard-reference the type to avoid coupling. Use reflection if present.
//        var t = homeManager.GetType();
//        var m = t.GetMethod("RefreshFromSave", System.Reflection.BindingFlags.Public | System.Reflection.BindingFlags.Instance);
//        if (m != null)
//        {
//            m.Invoke(homeManager, null);
//        }
//        else
//        {
//            // Fallback: if a method named ReportStageResult_1Based exists, call it to force a UI pass
//            var m2 = t.GetMethod("ReportStageResult_1Based", System.Reflection.BindingFlags.Public | System.Reflection.BindingFlags.Instance);
//            if (m2 != null)
//            {
//                // Call with the same stage we just updated and the mapped hp
//                float hpPercent = award == StarAward.HP100_3Star ? 100f :
//                                  award == StarAward.HP50Plus_2Star ? 50f : 1f;
//                m2.Invoke(homeManager, new object[] { stageIndex_1Based, hpPercent });
//            }
//        }
//    }
...
//    {
//        if (stagesPerLevel < 1) stagesPerLevel = 1;
//        if (stageIndex_1Based < 1) stageIndex_1Based = 1;
//        if (stageIndex_1Based > stagesPerLevel) stageIndex_1Based = stagesPerLevel;
//    }
//}
...
//        EditorGUILayout.PropertyField(serializedObject.FindProperty("levelId"));
//        EditorGUILayout.PropertyField(serializedObject.FindProperty("stagesPerLevel"));
//        EditorGUILayout.PropertyField(serializedObject.FindProperty("stageIndex_1Based"));
//        EditorGUILayout.Space(6);

//        EditorGUILayout.PropertyField(serializedObject.FindProperty("award"));
//        EditorGUILayout.PropertyField(serializedObject.FindProperty("homeManager"));
//        EditorGUILayout.Space(8);
...
//            EditorGUILayout.BeginHorizontal();
//            if (GUILayout.Button("Apply 1★ (Clear)"))
//            {
//                dm.award = DebugStageManager.StarAward.Clear_1Star;
//                dm.Apply();
//            }
//            if (GUILayout.Button("Apply 2★ (≥50% HP)"))
//            {
//                dm.award = DebugStageManager.StarAward.HP50Plus_2Star;
//                dm.Apply();
//            }
//            if (GUILayout.Button("Apply 3★ (100% HP)"))
//            {
//                dm.award = DebugStageManager.StarAward.HP100_3Star;
//                dm.Apply();
//            }
//            EditorGUILayout.EndHorizontal();

//            EditorGUILayout.HelpBox("Enter Play Mode. Pick Level, Stage, and click a button to record stars via SaveSystem. If HomeManager is assigned, the Home UI will refresh.", MessageType.Info);
//        }
