...
public class MenuLoader : MonoBehaviour
{
    ...
    private IEnumerator Start()
    {
        ...
        // menu. The "already seen" flag lives in SaveSystem, so this happens exactly
        // ONCE per save - clear it with Tools/Tutorial/Reset Tutorial Progress (or
        // wipe the save) to see it again. There is deliberately no on/off switch
        // here: the save flag is the only gate, so the tutorial cannot be left
        // disabled by a stale serialized value in StarterScene.
