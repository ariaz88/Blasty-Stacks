# SESSIONS-ARCHIVE.md — full history

> This file is **NOT injected into sessions**. It is the lossless archive behind `SESSIONS.md`.
> `SESSIONS.md` carries the short, live index; everything verbose lives here.
> Open it on demand when a one-line entry in `SESSIONS.md` is not enough.
>
> Archived on 2026-09-14 from the then-2814-line `SESSIONS.md`.

---

## Open Threads — verbatim snapshot, 2026-09-14

_The long-form text of every thread, as written by the session that opened it.
The live, compressed list is in `SESSIONS.md`._
...
## Decisions — verbatim full reasoning, 2026-09-14 snapshot

_The `Why` column in `SESSIONS.md` is abridged. This is the original, unabridged text._
